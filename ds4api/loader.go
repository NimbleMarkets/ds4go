...
func (l *Library) register() (err error) {
	...
	mustRegister(&r.ds4EnginePower, "ds4_engine_power")
	mustRegister(&r.ds4EngineSetPower, "ds4_engine_set_power")
	mustRegister(&r.ds4EngineVocabSize, "ds4_engine_vocab_size")
	mustRegister(&r.ds4EngineModelName, "ds4_engine_model_name")
	mustRegister(&r.ds4EngineModelID, "ds4_engine_model_id")
