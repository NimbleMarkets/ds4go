...
func TestEngineOptionsLayoutMatchesC(t *testing.T) {
	...
	checkOffsets(t, "ds4_engine_options", unsafe.Sizeof(o), 272, []fieldOffset{
		...
		{"dspark_exact_sampling", unsafe.Offsetof(o.DsparkExactSampling), 110},
		{"dspark_confidence_threshold_set", unsafe.Offsetof(o.DsparkConfidenceThresholdSet), 111},
		{"cuda_tensor_parallel", unsafe.Offsetof(o.CUDATensorParallel), 112},
		{"ssd_streaming", unsafe.Offsetof(o.SSDStreaming), 113},
		{"ssd_streaming_cold", unsafe.Offsetof(o.SSDStreamingCold), 114},
		{"ssd_streaming_full_layers_set", unsafe.Offsetof(o.SSDStreamingFullLayersSet), 115},
		{"inspect_only", unsafe.Offsetof(o.InspectOnly), 116},
		{"placement_ctx_hint", unsafe.Offsetof(o.PlacementCtxHint), 120},
		{"placement_session_count_hint", unsafe.Offsetof(o.PlacementSessionCountHint), 124},
		{"share_session_prefill_workspace", unsafe.Offsetof(o.ShareSessionPrefillWorkspace), 128},
		{"first_token_test", unsafe.Offsetof(o.FirstTokenTest), 129},
		{"metal_graph_test", unsafe.Offsetof(o.MetalGraphTest), 130},
		{"load_slice", unsafe.Offsetof(o.LoadSlice), 131},
		{"load_layer_start", unsafe.Offsetof(o.LoadLayerStart), 132},
		{"load_layer_end", unsafe.Offsetof(o.LoadLayerEnd), 136},
		{"load_output", unsafe.Offsetof(o.LoadOutput), 140},
